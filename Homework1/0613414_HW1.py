...
def MSE_main(b0, b1, lr, batch_size, batch_num, converge_count, converge_thres, x_train, y_train):
    log = {'b0':[], 'b1':[], 'loss':[] }
    count = 0
...
def MAE_main(b0, b1, lr, batch_size, batch_num, converge_count, converge_thres, x_train, y_train):    
    log = {'b0':[], 'b1':[], 'loss':[] }
    count = 0
...
if __name__ == '__main__':
    ...
    mse_log, mse_b0, mse_b1 = MSE_main(b0, b1, lr, batch_size, batch_num, converge_count, converge_thres, x_train, y_train)
    mae_log, mae_b0, mae_b1 = MAE_main(b0, b1, lr, batch_size, batch_num, converge_count, converge_thres, x_train, y_train)
    ...
    1. MAE, MSE, respectively
    2. Plot learning curve
    3. value of MAE, MSE
    4. value of b0, b1
    5. follow PEP8 coding style
